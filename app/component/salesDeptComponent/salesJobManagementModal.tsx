...
const Job_Management_Modal = ({ showModal, setShowModal, selectedJob, setSelectedJob, modalFor}: Job_Management_Props) => {
    ...
    const handleSelectDropdown = (dropdown: any, title:any)=>{
        if (title == 'attached'){
            ...
            setDropElements({...dropElements, [title]: dropdown.replace(/_/g, ' ')}); setDropMenus({...dropMenus, [title]: false})
        }else{            
    ...
    useEffect(() => {
        ...
        if (modalFor == 'add'){
            ...
            setAuth({...auth,  
                ...
                hoa_permit_submit_date, hoa_permit_approval_date, hoa_permit_number, 
                hoa_permit_cost: hoa_permit_cost || 0, hoa_permit_document,

                engineering_permit_status: engineering_permit_status.replace(/_/g, ' '), 
                engineering_permit_submit_date, engineering_permit_approval_date, 
                engineering_permit_number, engineering_permit_cost: engineering_permit_cost || 0, engineering_permit_document,

                general_permit_status: general_permit_status.replace(/_/g, " "), general_permit_submit_date, general_permit_approval_date, 
                            ...
                            <div className="w-auto min-h-[250px] flex flex-col justify-start items-center p-[10px] ">
                                ...
                                <div className="w-[70vw]  flex flex-col items-start justify-start gap-[25px] rounded-[4px] p-[15px] pt-0 ">
                                    ...
                                    <form  action="" className="w-full flex items-start justify-between gap-[20px] ">
                                        <div className="w-1/2 h-[67vh] flex flex-col items-start justify-start gap-[20px] overflow-y-auto ">
                                            ...
                                            <span className="w-full flex flex-col items-self justify-self gap-[10px] z-[20]">
                                                ...
                                                <span className="h-[40px] min-w-[150px] ">
                                                    <DropDownBlankTransparent handleSelectDropdown={handleSelectDropdown} title={'hoa_permit_status'} dropArray={['Required', 'Not Required', ]} dropElements={dropElements} dropMenus={dropMenus} handleDropMenu={handleDropMenu} setDropElements={setDropElements} setDropMenus={setDropMenus}  /> 
                                                </span>
                                            </span>
                                            ...
                                            <span className="w-full flex flex-col items-self justify-self gap-[10px] z-[10]">
                                                ...
                                                <span className="h-[40px] min-w-[150px] ">
                                                    <DropDownBlankTransparent handleSelectDropdown={handleSelectDropdown} title={'engineering_permit_status'} dropArray={['Required', 'Not Required', ]} dropElements={dropElements} dropMenus={dropMenus} handleDropMenu={handleDropMenu} setDropElements={setDropElements} setDropMenus={setDropMenus}  /> 
                                                </span>
                                            </span>

                                            <span className="w-full flex flex-col items-self justify-self gap-[10px] z-[5]">
                                                <p className="text-[15px]">General Permit</p>
                                                <span className="h-[40px] min-w-[150px] ">
                                                    <DropDownBlankTransparent handleSelectDropdown={handleSelectDropdown} title={'general_permit_status'} dropArray={['Required', 'Not Required', ]} dropElements={dropElements} dropMenus={dropMenus} handleDropMenu={handleDropMenu} setDropElements={setDropElements} setDropMenus={setDropMenus}  /> 
                                                </span>
                                            </span>
                                        ...
                                        <div className="w-1/2 h-[67vh] flex flex-col item-start justify-start gap-[20px] overflow-y-auto">
                                            ...
                                            <span className="w-full flex items-center justify-betweeen gap-[10px] ">
                                                <label className="flex items-center gap-[10px] ">
                                                    ...
                                                    <p className="text-[15px] cursor-pointer ">Attached</p>
                                                </label>
                                                ...
                                                <label className="flex items-center justify-end gap-[10px] ">
                                                    ...
                                                    <p className="text-[15px] cursor-pointer ">FreeStanding</p>
                                                </label>

                                                <label className="flex items-center justify-end gap-[10px] ">
                                                    <input type="radio" name="attachment" value="cantilever" className="h-[17px] w-[17px] cursor-pointer" onChange={() => setAuth({...auth, attached: "cantilever" })} checked={auth.attached === "cantilever"} />
                                                    <p className="text-[15px] cursor-pointer ">Cantilever</p>
                                                </label>
                                            </span>


                                            <span className="w-full flex flex-col items-self justify-self gap-[5px] ">
                                                <p className="text-[15px] flex items-center gap-[10px] ">Struture Type {auth.structure_type && <span className='font-medium flex gap-[10px] ' > - {auth.structure_type.replace(/_/g, " ")}</span>} </p>
                                    ...
                                    <span className="w-full flex items-center justify-end gap-[20px] ">

                                        <p className="text-white w-1/2">.</p>

                                        <button className=" w-1/2 h-[40px] text-white bg-blue-600 rounded-[3px] hover:bg-blue-700 flex items-center justify-center text-[15px] "  disabled={loading} onClick={create_job} >
                                        {loading ? (
                                            <svg className="w-[25px] h-[25px] animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="3"></circle>
                                                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z"></path>
                                ...
                                {modalFor == 'edit' && 
                                <div className="w-[80vw] flex flex-col items-start justify-start gap-[25px] rounded-[4px] p-[15px] pt-0 ">
                                    <span className="w-full flex flex-row items-center justify-between border-b border-slate-200 h-[55px]  ">
                                ...
                                {roll_next == "first" ? 
                                    ...
                                    <form action="" className="w-full flex items-start justify-between gap-[20px] overflow-y-auto ">
                                        <div className="w-1/2 h-[67vh] flex flex-col items-start justify-start gap-[20px] ">
                                        ...
                                        <div className="w-1/2 h-[67vh] flex flex-col item-start justify-start gap-[20px]">
                                            ...
                                            <span className="w-full flex flex-col items-self justify-self gap-[10px] ">
                                                <p className="text-[15px] flex items-center gap-[10px] ">Struture Type {auth.structure_type && <h5 className="font-medium flex gap-[10px] " > - {auth.structure_type.replace(/_/g, " ")}</h5>} </p>
                                                <span className="h-[40px] min-w-[150px] z-5">
                                                    <DropDownBlankTransparent handleSelectDropdown={handleSelectDropdown} title={'structure_type'} dropArray={['IRP', 'LATTICE', 'COMBO', 'FLAT PAN', 'LOUVER', 'HYBRID', ]} dropElements={dropElements} dropMenus={dropMenus} handleDropMenu={handleDropMenu} setDropElements={setDropElements} setDropMenus={setDropMenus}  /> 
                                                </span>
                                            </span>
                                    ...
                                    <form  action="" className="w-full flex items-start justify-between gap-[20px] overflow-y-auto ">
                                        <div className="w-1/3 flex h-[67vh] flex-col item-start justify-start gap-[20px] overflow-y-auto " >
                                            ...
                                            <span className="w-full flex flex-col items-self justify-self gap-[10px] z-[20]">
                                                <p className="text-[15px]">Hoa Permit</p>
                                                <span className="h-[40px] min-w-[150px] z-5">
                                                    <DropDownBlankTransparent handleSelectDropdown={handleSelectDropdown} title={'hoa_permit_status'} dropArray={["Required", "Not Required", "Pending", "Submitted", "Approved" ]} dropElements={dropElements} dropMenus={dropMenus} handleDropMenu={handleDropMenu} setDropElements={setDropElements} setDropMenus={setDropMenus}  /> 
                                                </span>
                                            </span>
                                        ...
                                        <div className="w-1/3 flex h-[67vh] flex-col item-start justify-start gap-[20px] overflow-y-auto " >
                                            ...
                                            <span className="w-full flex flex-col items-self justify-self gap-[10px] z-[20] ">
                                                <p className="text-[15px]">Engineering Permit</p>
                                                <span className="h-[40px] min-w-[150px] z-5">
                                                    <DropDownBlankTransparent handleSelectDropdown={handleSelectDropdown} title={'engineering_permit_status'} dropArray={["Required", "Not Required", "Pending", "Submitted", "Approved" ]} dropElements={dropElements} dropMenus={dropMenus} handleDropMenu={handleDropMenu} setDropElements={setDropElements} setDropMenus={setDropMenus}  /> 
                                                </span>
                                            </span>
                                        ...
                                        <div className="w-1/3 flex h-[67vh] flex-col item-start justify-start gap-[20px] overflow-y-auto " >
                                            ...
                                            <span className="w-full flex flex-col items-self justify-self gap-[10px] z-[20] ">
                                                <p className="text-[15px]">General Permit</p>
                                                <span className="h-[40px] min-w-[150px] z-5">
                                                    <DropDownBlankTransparent handleSelectDropdown={handleSelectDropdown} title={'general_permit_status'} dropArray={["Required", "Not Required", "Pending", "Submitted", "Approved" ]} dropElements={dropElements} dropMenus={dropMenus} handleDropMenu={handleDropMenu} setDropElements={setDropElements} setDropMenus={setDropMenus}  /> 
                                                </span>
                                            </span>
...

                                {
                                    ...
                                    <span className="w-full flex items-center gap-[15px] justify-between ">
                                        <p className="text-white w-1/2">.</p>

                                        <button className=" w-1/2 h-[40px] mt-[5px] text-white bg-blue-700 rounded-[3px] hover:bg-blue-600 flex items-center justify-center text-[15px] "  disabled={loading} onClick={()=>{ setRoll_next('permit') }} >
                                        {loading ? (
                                            <svg className="w-[25px] h-[25px] animate-spin text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                                                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="3"></circle>
                                                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8H4z"></path>
                                ...
                                <div className="w-[77.5vw] flex flex-col items-start justify-start gap-[25px] rounded-[4px] p-[15px] ">
                                    <span className="w-full flex items-center justify-start border-b border-slate-200 h-[45px] gap-[20px] ">
                                        ...
                                        <span className="text-md  text-slate-800 flex items-center justify-start gap-[10px] font-medium">
                                            Job Id: <span className='font-semibold'>{selectedJob.job_ind}</span> 
                                        </span>
                                    ...
                                    <form  action="" className="w-full flex items-start justify-between gap-[15px]">
                                        <div className="w-1/2 h-[75vh] flex flex-col items-start justify-start gap-[15px] overflow-y-auto">
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                                ...
                                                <p className="text-sm w-[55%] font-medium "> {selectedJob.job_ind}</p>
                                            </span>
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                                <p className="text-sm w-[45%] ">Job Number</p>
                                                <p className="text-sm w-[55%] font-medium "> {selectedJob.job_number || '-'}</p>
                                            </span>
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                                <p className="text-sm w-[45%] ">Lead Id</p>
                                                <p className="text-sm w-[55%] font-medium "> {selectedJob.lead.lead_ind }</p>
                                            </span>
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                                <p className="text-sm w-[45%] ">Added By</p>
                                                <p className="text-sm w-[55%] font-medium "> {selectedJob.job_adder.first_name }  {selectedJob.job_adder.last_name } </p>
                                            </span>
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                            ...
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                                <p className="text-sm w-[45%] ">Cantilever</p>
                                                <p className="text-sm w-[55%] font-medium ">{selectedJob.project[0].attached == 'cantilever' ? 'True': 'False'}</p>
                                            </span>
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                        ...
                                        <div className="w-1/2 h-[75vh] flex flex-col item-start justify-start gap-[15px] overflow-y-auto">
                                            ...
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                                <p className="text-sm w-[50%] ">General Permit</p>
                                            ...
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                                <p className="text-sm w-[50%] ">Hoa Permit</p>
                                            ...
                                            <span className="w-full flex items-start justify-start gap-[10px]  ">
                                                <p className="text-sm w-[50%] ">Engineering Permit</p>
