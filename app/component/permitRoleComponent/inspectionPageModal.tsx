...
const InspectionModal = ({ showModal, setShowModal, selectedItem, setSelectedItem, show, setShow }: DeleteTaskProps) => {
    ...
    return (
        <div className="fixed z-30 inset-0 overflow-y-auto" id="modal">
            <div className="relative flex items-center justify-center min-h-screen">
                ...
                <div className={addPermit ? "w-full h-screen pt-[50px] rounded-lg overflow-hidden shadow-xl transform transition-all": "w-full h-screen pt-[50px] rounded-lg overflow-hidden shadow-xl transform transition-all"} role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-description" onClick={handleCloseModal}>
                    <div className={addPermit ? "h-auto w-[42.5%] mx-auto shadow-xl flex items-start ": "h-auto w-[42.5%] mx-auto shadow-xl flex items-start "}>
                                    ...
                                    <div className="w-full flex flex-row items-start justify-between gap-[15px] ">
                                        ...
                                        <div className="w-full flex flex-col items-start justify-start gap-[10px]">
                                            ...
                                            <div className="w-full flex flex-col items-start justify-start gap-2">
                                                ...
                                                <span className="w-full flex flex-row items-center justify-start gap-2">
                                                    <p className="text-[15.5px] font-normal">Inspection Date:</p>
                                                    <p className="text-[15.5px] font-medium">July 5, 2024</p>
                                                </span>
                                                <span className="w-full flex flex-row items-center justify-start gap-2">
                                                    <p className="text-[15.5px] font-normal">Inspector Name:</p>
                                                    <p className="text-[15.5px] font-medium">Jane Doe</p>
                                                </span>
                                                <span className="w-full flex flex-row items-center justify-start gap-2">
                                                ...
                                                <span className="w-full flex flex-col items-start justify-start gap-2">
                                                    <p className="text-[15.5px] font-normal">Notes:</p>
                                                    <div className="w-full flex flex-col items-start justify-start gap-2">
                                                        {['The site needs to be cleared of debris before.', 'Inspection can be completed.'].map((data, ind)=>{
                                                            return(
                                                                <p key={ind} className="text-[15.5px] font-medium">{ind + 1}. {data}</p>
                                                            )
                                                        })}
                                                    </div>
                                                </span>
