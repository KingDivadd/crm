...
const TaskManagement = () => {
    ...
    return (
        <div className="w-full h-full p-[10px] pb-[10px] ">
            ...
            {showModal && <TaskModal showModal={showModal} setShowModal={setShowModal} modalFor={modalFor} selectedLead={selectedLead} setModalFor={setModalFor} setSelectedLead={setSelectedLead} /> }
        </div>
    )
}
