                                        ...
                                        <div className="w-full flex flex-col items-start justify-start gap-[10px]">
                                            ...
                                            <div className="w-full flex flex-col items-start justify-start gap-2 border-t border-gray-300 pt-1 ">
                                                <span className="w-full flex flex-row items-center justify-start gap-2">
                                                    ...
                                                    <p className="text-[15.5px] font-medium text-start">Please provide additional details on the structural      |
                                                    | design for the west wing. </p>
                                                </span>

                                                <span className="w-full flex flex-row items-center justify-start gap-2">
                                                    <p className="text-[15.5px] font-normal">Attachment</p>
                                                    <p className="text-[15.5px] font-medium text-start">Structural_Design_WestWing.pdf </p>
                                                </span>
                                                        ...
                                                        {[{title: 'Date', value: '2024-07-02'}, {title: 'Message', value: ' Additional details will be provided shortly.'}].map((data, ind)=>{
                                                            return(
                                                                <span key={ind} className="w-full flex flex-row items-center justify-start gap-2">
                                                                    <p className="text-[15.5px] font-normal">{ind + 1}. {data.title}</p>
                                                                    <p className="text-[15.5px] font-normaltext-start">{data.value} </p>
                                                                </span>
                                                            )
                                                        })}
                                                    </span>
