...
const InvoicePage = () => {
    ...
    return (
        <div className="w-full h-full p-[10px] pb-[10px] ">
            <div className="relative w-full h-full flex flex-col items-start justify-start gap-[10px]">
                ...
                <span className="w-full flex flex-row items-center justify-between">
                    <span className="h-full flex flex-row items-center justify-start gap-4">
                        <p className="text-lg font-semibold text-black">Invoices</p>
                ...
                <div className="w-full min-h-[150px] flex flex-col bg-white shadow-lg rounded-[5px]">
                    ...
                    <span className="w-full h-[40px] flex flex-row items-center justify-start rounded-t-[3px] bg-blue-700 text-white">
                        <p className="text-sm font-normal w-[7.5%] px-2 ">Invoice Id</p>
                        <p className="text-sm font-normal w-[14.5%] px-2 ">Customer Name</p>
                        <p className="text-sm font-normal w-[25%] px-2 ">Date Issued</p>
                        <p className="text-sm font-normal w-[13%] px-2 ">Date Due</p>
            ...
            {showModal && <InvoiceModal showModal={showModal} setShowModal={setShowModal} modalFor={modalFor} selectedLead={selectedLead} setModalFor={setModalFor} setSelectedLead={setSelectedLead} /> }
        </div>
    )
}
