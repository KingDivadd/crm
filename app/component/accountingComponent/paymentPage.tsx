...
import PaymentPageModal from './paymentPageModal';
...
const PaymentPage = () => {
    ...
    return (
        <div className="w-full h-full p-[10px] pb-[10px] ">
            <div className="relative w-full h-full flex flex-col items-start justify-start gap-[10px]">
                ...
                <span className="w-full flex flex-row items-center justify-between">
                    <span className="h-full flex flex-row items-center justify-start gap-4">
                        <p className="text-lg font-semibold text-black">Payments</p>
                    ...
                    <span className="flex flex-row items-start justify-start gap-4">
                        <span className=" flex flex-row items-center justif-start gap-5 h-[40px] ">
                            ...
                            {(role == 'accounting' || role == 'admin') && <button type="button" className="h-full px-4 flex items-center text-white bg-blue-700 hover:bg-blue-700 rounded-[4px] text-sm" onClick={add_lead}>Add Lead</button>}
                        </span>
                ...
                <div className="w-full min-h-[150px] flex flex-col bg-white shadow-lg rounded-[5px]">
                    ...
                    <span className="w-full h-[40px] flex flex-row items-center justify-start rounded-t-[3px] bg-blue-700 text-white">
                        ...
                        <p className="text-sm font-normal w-[12%] px-2 ">Invoice Id</p>
                        <p className="text-sm font-normal w-[12.5%] px-2 ">Project Id</p>
                        <p className="text-sm font-normal w-[13%] px-2 ">Client Name</p>
                        <p className="text-sm font-normal w-[12.5%] px-2 ">Date Paid</p>
                        <p className="text-sm font-normal w-[10%] px-2 ">Amount</p>
                                ...
                                { filtered_lead_box?.leads.map((data:any, ind:number)=>{
                                    ...
                                    return (
                                        ...
                                        <span className="recent-activity-table-list " >
                                            ...
                                            <p className="text-sm w-[12.5%] px-2 "> {address} </p>
                                            ...
                                            <p className="text-sm w-[7.5%] px-2 flex flex-row items-center justify-start gap-2 hover:underline  hover:text-green-600 cursor-pointer" onClick={()=>{view_lead(data)}} >view</p>

                                            <p className="text-sm w-[10%] px-2 flex flex-row items-center justify-start gap-2 hover:text-red-400 cursor-pointer" onClick={()=>edit_lead(data)} > <MdEdit size={16} /> Edit</p>
            ...
            {showModal && <PaymentPageModal showModal={showModal} setShowModal={setShowModal} modalFor={modalFor} selectedLead={selectedLead} setModalFor={setModalFor} setSelectedLead={setSelectedLead} /> }
        </div>
    )
}
