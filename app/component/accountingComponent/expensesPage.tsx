...
import ExpensesModal from './expensesPageModal';
...
const ExpensesPage = () => {
    ...
    return (
        <div className="w-full h-full p-[10px] pb-[10px] ">
            <div className="relative w-full h-full flex flex-col items-start justify-start gap-[10px]">
                ...
                <span className="w-full flex flex-row items-center justify-between">
                    <span className="h-full flex flex-row items-center justify-start gap-4">
                        <p className="text-lg font-semibold text-black">Expenses</p>
                ...
                <div className="w-full min-h-[150px] flex flex-col bg-white shadow-lg rounded-[5px]">
                    ...
                    <span className="w-full h-[40px] flex flex-row items-center justify-start rounded-t-[3px] bg-blue-700 text-white">
                        <p className="text-sm font-normal w-[10%] px-2 ">Expenses Id</p>
                        <p className="text-sm font-normal w-[12%] px-2 ">Date</p>
                        <p className="text-sm font-normal w-[13%] px-2 ">Category</p>
                        <p className="text-sm font-normal w-[25%] px-2 ">Description</p>
                        <p className="text-sm font-normal w-[12.5%] px-2 ">Amount</p>
            ...
            {showModal && <ExpensesModal showModal={showModal} setShowModal={setShowModal} modalFor={modalFor} selectedLead={selectedLead} setModalFor={setModalFor} setSelectedLead={setSelectedLead} /> }
        </div>
    )
}
