        ...
        <div className="fixed z-30 inset-0 overflow-y-auto" id="modal">
            <div className="relative flex items-center justify-center min-h-screen">
                ...
                <div className={edit ? "w-full h-screen pt-[20px] rounded-lg overflow-hidden shadow-xl transform transition-all": "w-full h-screen pt-[70px] rounded-lg overflow-hidden shadow-xl transform transition-all"} role="dialog" aria-modal="true" aria-labelledby="modal-title" aria-describedby="modal-description" onClick={handleCloseModal}>
                    <div className={edit ? "h-auto w-[42.5%] mx-auto shadow-xl flex items-start ": "h-auto w-[70%] mx-auto shadow-xl flex items-start "}>
                            ...
                            <div className="w-full min-h-[300px] flex flex-col justify-start items-center p-[20px] ">
                                ...
                                <div className="w-full flex flex-col items-start justify-start gap-[15px] ">
                                    <span className="w-full flex flex-row items-start justify-start border-b border-gray-300 h-[40px]">
                                        <p className="text-lg font-semibold  text-blue-600 ">Edit Task </p>
                                    </span>

                                    <div className="w-full flex flex-row items-start justify-start gap-[20px]">
                                        <div className="w-full flex flex-col gap-[10px]">
                                            <span className="w-full flex flex-row items-start justify-start border-b border-gray-300 h-[40px] gap-3">
                                                <p className="text-md  ">Task ID: </p>
                                                <p className="text-md font-semibold  ">TS10001234 </p>
                                            </span>
                                            ...
                                            <span className="w-full flex flex-col items-start justify-start gap-2 z-[10]">
                                                ...
                                                <input type="text" name="" id="" placeholder='Enter task description here.' className="normal-input focus:bg-transparent" />
                                            </span>

                                            <span className="w-full flex flex-col items-start justify-start gap-2 z-[15]">
                                ...
                                <div className="w-full flex flex-col items-start justify-start gap-[10px]  h-full ">
                                    ...
                                    <div className="w-full flex flex-row items-start justify-between gap-[15px] ">
                                        ...
                                        <div className="w-full flex flex-col items-start justify-start gap-[10px]">
                                            <p className="text-lg h-[35px] border-b border-gray-300 w-full text-start">Task ID: TS1000123</p>
                                            <div className="w-full flex flex-col items-start justify-start gap-2">
                                                <span className="w-full flex flex-row items-center justify-start gap-2">
                                                    <p className="text-[15.5px] font-normal">Task Description:</p>
                                                    <p className="text-[15.5px] font-medium text-start">Install wiring for Project X</p>
                                                </span>
                                                ...
                                                <span className="w-full flex flex-row items-center justify-start gap-2">
                                                    <p className="text-[15.5px] font-normal">Assigned To:</p>
                                                    <p className="text-[15.5px] font-medium text-start">John Smith </p>
                                                </span>
...
export default ElectricalModal