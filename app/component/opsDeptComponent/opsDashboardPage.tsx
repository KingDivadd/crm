...
import SchedulingAndLogistics from './opsSchedulingLogistic'
        ...
        <div className="w-full p-[10px] pb-[10px]">
            <div className="w-full h-full flex flex-col items-start justify-start gap-[30px]">
                ...
                <div className="w-full flex flex-col items-start justify-start gap-[10px] ">
                    <p className="text-xl font-semibold">Project Work Flow</p>

                    <div className="w-full min-h-[150px] flex flex-col bg-white rounded-[5px] border border-blue-500 ">
                        <span className="w-full h-[40px]  flex flex-row items-center justify-start bg-white rounded-t-[5px] border-b-2 border-gray-200 ">
                            <p className="text-sm font-semibold w-[25%] pr-2 pl-2 ">HOA Approval</p>
                            <p className="text-sm font-semibold w-[25%] pr-2 pl-2 ">Engineering </p>
                            <p className="text-sm font-semibold w-[25%] pr-2 pl-2 ">Permit Approval</p>
                            <p className="text-sm font-semibold w-[25%] pr-2 pl-2 ">Installation</p>
                        </span>
                ...
                <div className="w-full flex flex-col gap-4">
                    <p className="text-xl font-semibold">Scheduling and Logistics</p>
                ...
                <div className="w-full flex flex-col items-start justify-start gap-[10px] ">
                    ...
                    <div className="w-full min-h-[150px] flex flex-col bg-white rounded-[5px] border border-blue-500 ">
                        <span className="w-full h-[40px]  flex flex-row items-center justify-start bg-white rounded-t-[5px] border-b-2 border-gray-200 ">
                            ...
                            <p className="text-sm font-semibold w-[20%] pr-2 pl-2 ">Approval Step</p>
                            <p className="text-sm font-semibold w-[20%] pr-2 pl-2 ">Project Status</p>
                            <p className="text-sm font-semibold w-[20%] pr-2 pl-2 ">Approval Date</p>
                            <p className="text-sm font-semibold w-[20%] pr-2 pl-2 ">Responsible Team</p>
                        </span>
                        <div className="w-full  flex flex-col justify-start items-start">
                            {[1,2,3,4,5].map((data, ind)=>{
                                return (
                                    <span key={ind} className="approval-flow-table-list">
                                        <span className="w-[20%] flex flex-col items-start justify-betw">
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Project Alpha</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Project Alpha</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Project Alpha</p>
                                        </span>
                                        <span className="w-[20%] flex flex-col items-start justify-betw">
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">HOA</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Engineering</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Permit</p>
                                        </span>
                                        <span className="w-[20%] flex flex-col items-start justify-betw">
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Completed</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">In Progress</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Pending</p>
                                        </span>
                                        <span className="w-[20%] flex flex-col items-start justify-betw">
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">June 12, 2024</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">N/A</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">N/A</p>
                                        </span>
                                        <span className="w-[20%] flex flex-col items-start justify-betw">
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">HOA Team</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Engineering Team</p>
                                            <p className="text-sm  pr-2 pl-2 h-[30px] ">Permit Team</p>
                                        </span>
                                    </span>
                                )
                            })}
