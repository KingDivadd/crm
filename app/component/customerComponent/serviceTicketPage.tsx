...
const ServiceTicketPage = () => {
    ...
    return (
        <div className="w-full flex p-[10px] ">
            <div className="w-full h-full flex flex-col gap-[25px] ">
                ...
                <div className="w-full flex flex-col items-start justify-start gap-[10px] ">
                    <span className="w-full flex flex-row items-center justify-between">
                        ...
                        <p className="text-md font-semibold text-blue-600 hover:underline cursor-pointer" onClick={createTicket} >Create Ticket</p>
                    </span>
            ...
            {showModal && <CreateTicketModal showModal={showModal} setShowModal={setShowModal} selectedItem={selectedItem} setSelectedItem={setSelectedItem} setShow={setShow} show={show} />}
        </div>
    )
}
