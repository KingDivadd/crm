...
const Dashboard = () => {
    ...
    useEffect(() => {
        ...
        if (!trimmedRole || !['admin', 'sales', 'operation', 'customer', 'installer', 'permit', 'engineering', 'electrical', 'accounting'].includes(trimmedRole)) {
    ...
    return (
        <div className="">
            ...
            {userRole === 'operation' && <ElecricalDashbaord />}
